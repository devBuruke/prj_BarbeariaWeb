    ...
    <header>
        <div class="cor_index">
            ...
            <center class="cor_index">
                ...
                <button type="submit"><a href="Page_myAgenda.php">Meus Agendametos</a></button>
                <button type="submit"><a href="Page_editar.php">Editar Perfil</a></button>
                <button type="submit"><a href="index.php">Sair</a></button>
