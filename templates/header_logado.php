...
<body>
    <header>
        <div class="cor_index">
            ...
            <!-- <li><a href="">Home</a></li> -->
            <li class="dropdown">
            <a href="javascript:void(0)" class="dropbtn"><span name="perfil" class="material-symbols-outlined iconConta brasaodir">account_circle</span></a>
            <div class="dropdown-content">
            <a href="Page_editar.php">Editar Meu perfil</a>
            <a href="Page_MeusAgendamentos.php">Meus Agendamentos</a>
